...
export const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[70vh] flex items-center bg-brand-black overflow-hidden w-full">
      {/* Background Layer - Added pointer-events-none to prevent click interception */}
      <div className="absolute inset-0 z-0 bg-brand-black pointer-events-none">
        <img 
      ...
      {/* Content Container - Increased z-index to ensure it is above all decorative elements */}
      <div className="container mx-auto px-4 md:px-12 relative z-20 py-12">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          
          <div className="w-full lg:w-1/2 text-left space-y-6 relative z-30">
            ...
            <div className="flex flex-wrap gap-4 pt-4">
              <Link 
                to="/book"
                className="bg-brand-yellow text-brand-black font-heading tracking-widest text-base py-4 px-10 rounded-full hover:bg-brand-orange hover:text-white transition-all duration-300 transform hover:scale-105 shadow-[0_0_20px_rgba(255,199,0,0.3)] relative z-40"
              >
                Book Now
              </Link>
              <a 
                href="tel:+917686022245"
                className="bg-white/10 border border-white/20 text-white font-heading tracking-widest text-base py-4 px-10 rounded-full hover:bg-white hover:text-brand-black transition-all duration-300 transform hover:scale-105 relative z-40"
              >
                Call Us
              </a>
            </div>
          ...
          {/* Decorative Text - Added pointer-events-none */}
          <div className="hidden lg:flex w-full lg:w-1/2 justify-center lg:justify-end pointer-events-none">
      ...
      {/* Bottom Gradient Overlay - Changed z-index and added pointer-events-none */}
